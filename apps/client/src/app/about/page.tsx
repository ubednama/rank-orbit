        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
              Rank Orbit wasn't built by a faceless corporation. It started as a passion project to
              solve a simple problem:{" "}
              <span className="font-bold text-gray-900 dark:text-white">
                SEO tools are too complex and expensive.
              </span>{" "}
              My mission is to democratize search engine optimization for builders, creators, and
              startups.
            </p>
            ...
            <div className="mt-12 p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-xs">
              <div className="mb-4">
                ...
                <p className="text-sm text-indigo-600 dark:text-indigo-400 font-medium">
                  Engineer. Learning new things.
                </p>
              </div>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6">
                "I build tools that I wish I had when I started. Rank Orbit is the culmination of
                years of experience in full-stack development and growth hacking. Let's connect and
