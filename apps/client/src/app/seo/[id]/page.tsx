    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-gray-50 dark:bg-black pt-24 pb-12 transition-colors duration-500">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-8">
                ...
                >
                    <Button variant="ghost" className="pl-0 hover:bg-transparent hover:text-indigo-500" onClick={() => window.location.href = '/'}>
                ...
                >
                    <div>
                        <div className="flex items-center space-x-3 mb-2">
                            <Badge variant="outline" className="border-indigo-500 text-indigo-500 bg-indigo-500/10">
                                Report ID: {id}
                            </Badge>
                            <span className="text-xs text-muted-foreground">{date}</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 dark:text-white mt-2">
                            SEO Audit <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">Report</span>
                        </h1>
                    ...
                    <div className="flex space-x-3">
                        <Button variant="outline" className="border-gray-200 dark:border-white/10" onClick={() => window.print()}>Export PDF</Button>
                        <Button className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white shadow-lg shadow-indigo-500/20" onClick={() => window.location.href = '/'}>
                            New Audit
                        </Button>
                    </div>
                </motion.div>
                ...
                {(loading || data) && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <PerformanceScore score={data?.lighthouse_metrics?.performance_score} loading={loading} />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                <AIInsightsSection data={data?.ai_analysis || null} loading={loading || aiLoading} />
                            </div>
