                ...
                <div className="flex items-center space-x-4 mb-4">
                    <div className="relative">
                        <div className="w-12 h-12 rounded-xl bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center">
                            {step === 0 && <Search className="w-6 h-6 text-indigo-600 dark:text-indigo-400 animate-pulse" />}
                            {step === 1 && <Server className="w-6 h-6 text-indigo-600 dark:text-indigo-400 animate-pulse" />}
                            {step === 2 && <BarChart className="w-6 h-6 text-indigo-600 dark:text-indigo-400 animate-pulse" />}
                            {step >= 3 && <Zap className="w-6 h-6 text-indigo-600 dark:text-indigo-400 animate-pulse" />}
                        </div>
