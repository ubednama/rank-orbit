      ...
      <div className="w-full max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="flex-1 space-y-8 md:space-y-10">
            <h2 className="text-3xl md:text-5xl font-bold bg-clip-text text-gray-900 dark:text-white bg-linear-to-r from-gray-900 to-indigo-600 dark:from-white dark:to-indigo-400 leading-tight">
          ...
          <div className="flex-1 relative">
            <div className="absolute inset-0 bg-linear-to-tr from-indigo-500 to-purple-500 rounded-3xl blur-2xl opacity-20 dark:opacity-30"></div>
            <div className="relative rounded-3xl overflow-hidden border border-gray-200 dark:border-white/10 shadow-2xl bg-white dark:bg-black/50">
              ...
              <div className="aspect-video bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-black p-8 flex items-center justify-center">
