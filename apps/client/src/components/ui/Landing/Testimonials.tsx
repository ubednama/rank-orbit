...
const testimonials = [
  {
    ...
    content:
      "Rank Orbit is a game changer for our agency. The multilingual support and deep insights have helped us scale our operations across the MENA region.",
    stars: 5,
  ...
  },
  {
    ...
    content:
      "I love the developer-first approach. The API documentation is top-notch, and integrating the audit results into our CI/CD pipeline was seamless.",
    stars: 5,
  ...
  },
  {
    ...
    content:
      "As a bootstrap founder, I needed an affordable yet powerful tool. Rank Orbit delivered exactly that. My organic traffic doubled in just 4 months.",
    stars: 5,
  ...
  },
  {
    ...
    content:
      "The content gap analysis helped us uncover keywords we never thought of. It's incredibly intuitive and the reporting features are beautiful.",
    stars: 5,
  ...
  },
  {
    ...
    content:
      "Finally, an SEO tool that actionable. It doesn't just dump data; it tells you exactly what to fix. Highly recommended for any marketing team.",
    stars: 4,
  ...
  },
  {
    ...
    content:
      "Our product pages instantly ranked higher after implementing the schema suggestions. The ROI on this tool is insane.",
    stars: 5,
