...
const features = [
  {
    ...
    description:
      "Our crawler analyzes your HTML structure, meta tags, and content hierarchy to find critical ranking factors.",
  },
  {
    icon: <Zap className="w-6 h-6 text-yellow-400" />,
    title: "Lighthouse Performance",
    description:
      "Integrated with Google Lighthouse to measure Core Web Vitals, performance metrics, and accessibility scores.",
  },
  {
    icon: <Bot className="w-6 h-6 text-purple-400" />,
    title: "AI-Powered Insights",
    description:
      "Get human-readable summaries and actionable recommendations generated by advanced LLMs (Gemini Pro).",
  },
  {
    icon: <Globe className="w-6 h-6 text-blue-400" />,
    title: "Global Crawling",
    description:
      "Our distributed microservices architecture ensures fast and reliable crawling from multiple regions.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Track your SEO health over time with historical data and trend analysis (Dashboard).",
  },
];
