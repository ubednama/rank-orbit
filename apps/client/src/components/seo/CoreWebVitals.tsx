...
function NoDataCard({ title, icon: Icon, target }: { title: string; icon: React.ElementType; target: string }) {
    return (
        ...
        <>
            <Card className="bg-white/40 dark:bg-white/5 backdrop-blur-md border-gray-200/50 dark:border-white/10 hover:border-indigo-500/30 transition-colors">
                ...
                <CardContent>
                    ...
                    <Badge variant={data.lcp && parseFloat(data.lcp) <= 2.5 ? "outline" : "secondary"} className="mt-2">
                        Target: &lt; 2.5s
                    </Badge>
                </CardContent>
            </Card>
            <Card className="bg-white/40 dark:bg-white/5 backdrop-blur-md border-gray-200/50 dark:border-white/10 hover:border-indigo-500/30 transition-colors">
                ...
                <CardContent>
                    ...
                    <Badge variant={data.cls && parseFloat(data.cls) <= 0.1 ? "outline" : "secondary"} className="mt-2">
                        Target: &lt; 0.1
                    </Badge>
                </CardContent>
            </Card>
            <Card className="bg-white/40 dark:bg-white/5 backdrop-blur-md border-gray-200/50 dark:border-white/10 hover:border-indigo-500/30 transition-colors">
                ...
                <CardContent>
                    ...
                    <Badge variant={data.tbt && parseInt(data.tbt) <= 200 ? "outline" : "secondary"} className="mt-2">
                        Target: &lt; 200ms
                    </Badge>
                </CardContent>
            </Card>
